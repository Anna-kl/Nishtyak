...
Revision ID: 46e3a6cde4c3
Revises: 
Create Date: 2022-02-05 15:49:37.282015
...
def downgrade():
    ...
    sa.Column('createAdd', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('closeAdd', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['idUser'], ['users.id'], name='coupons_idUser_fkey'),
    ...
    sa.Column('dttmExpired', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('status', sa.BOOLEAN(), autoincrement=False, nullable=True),
    ...
    sa.Column('idUser', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('dttm_add', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['idUser'], ['users.id'], name='logs_idUser_fkey'),
    ...
    op.create_table('use_coupons',
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('idCoupon', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('idBacket', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.Column('option', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['idBacket'], ['backets.id'], name='use_coupons_idBacket_fkey'),
    sa.PrimaryKeyConstraint('id', name='use_coupons_pkey')
    )
